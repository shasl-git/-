...
\begin{code}
\captionof*{listing}{\centering\label{code:auth-01}Компонент страницы аутентификации}
\vspace{-0.75cm}\begin{minted}[fontsize=\tiny]{JS}
// app/login/page.tsx
'use client';
...
\begin{code}
\captionof*{listing}{\centering\label{code:cluster-01}Компонент страницы класстерного анализа}
\vspace{-0.75cm}\begin{minted}[fontsize=\tiny]{JS}
"use client";
import { useRouter } from "next/navigation";
...
\begin{code}
\captionof*{listing}{\centering\label{code:selling}Компонент страницы продаж}
\vspace{-0.75cm}\begin{minted}[fontsize=\tiny]{JS}
"use client";
import { useRouter } from "next/navigation";
import { useState, useRef, useEffect } from "react";
...
\begin{code}
\captionof*{listing}{\centering\label{code:test-unit}Компонент страницы юнит экономики}
\vspace{-0.75cm}\begin{minted}[fontsize=\tiny]{JS}
"use client";
import { useRouter } from "next/navigation";
